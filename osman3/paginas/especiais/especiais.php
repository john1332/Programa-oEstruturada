...
<section class="BuscaEspecial">
    ...
    <div>        
        <button><a href="index.php?menuop=produtos-por-valor-asc">Estado com produto mais caro</a> </button>
    </div>
    <div>        
        <button><a href="index.php?menuop=produtos-por-valorlucro-asc">Estado com produto mais caro</a> </button>
    </div>
</section>